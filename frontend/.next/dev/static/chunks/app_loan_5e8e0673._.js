...
function getEnvVar(key, fallback = '') {
    try {
        ...
        // Silently return fallback instead of logging to prevent console spam
        return fallback;
    }
}
...
;
;
// Wrap environment access in try-catch to prevent errors during SSR
let safeAppConfig = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$loan$2f$config$2f$environment$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["appConfig"];
try {
    safeAppConfig = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$loan$2f$config$2f$environment$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["appConfig"];
} catch (error) {
    console.warn('Error loading app config, using defaults');
    safeAppConfig = {
        env: 'development',
        domain: 'localhost:3000',
        mainSiteDomain: 'https://yellowmetal.co',
        ...
        security: {
            adminSecretKey: 'default_dev_key'
        }
    };
}
function LoanPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoanPage.useEffect": ()=>{
            try {
                ...
                ;
                // Log environment configuration in development (with error handling)
                try {
                    if (safeAppConfig?.env === 'development') {
                ...
                try {
                    if (safeAppConfig?.env === 'production') {
...
//# sourceMappingURL=app_loan_5e8e0673._.js.map