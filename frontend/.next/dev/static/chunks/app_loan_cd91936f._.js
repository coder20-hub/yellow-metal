...
function LoanCalculator() {
    ...
    const [interestRate, setInterestRate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(9.0);
    const [interestRateLoading, setInterestRateLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoanCalculator.useEffect": ()=>{
            const fetchInterestRate = {
                "LoanCalculator.useEffect.fetchInterestRate": async ()=>{
                    try {
                        setInterestRateLoading(true);
                        const backendBase = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_BACKEND_URL || 'http://localhost:4000';
                        const controller = new AbortController();
                        const timeoutId = setTimeout({
                            "LoanCalculator.useEffect.fetchInterestRate.timeoutId": ()=>controller.abort()
                        }["LoanCalculator.useEffect.fetchInterestRate.timeoutId"], 5000); // 5 second timeout
            ...
            }["LoanCalculator.useEffect.fetchInterestRate"];
            fetchInterestRate();
        }
    }["LoanCalculator.useEffect"], []);
...
_s(LoanCalculator, "Ds3eVEBSBP6Eu6fVvbRH28aR+ok=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$loan$2f$contexts$2f$LanguageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"],
...
function ApplicationForm() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ApplicationForm.useEffect": ()=>{
            const fetchBranches = {
                "ApplicationForm.useEffect.fetchBranches": async ()=>{
                    try {
                        const backendBase = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_BACKEND_URL || 'http://localhost:4000';
                        const res = await fetch(`${backendBase}/api/branches`);
                        const data = await res.json();
                        if (data.success && data.branches) {
                            setBranches(data.branches.sort({
                                "ApplicationForm.useEffect.fetchBranches": (a, b)=>a.town.localeCompare(b.town)
                            }["ApplicationForm.useEffect.fetchBranches"]));
                        }
                    } catch (err) {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        branchesLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ApplicationForm, "dGsNMzKH/gvINhSpAPwJHwo/4j0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$loan$2f$contexts$2f$LanguageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"]
    ];
});
...
//# sourceMappingURL=app_loan_cd91936f._.js.map