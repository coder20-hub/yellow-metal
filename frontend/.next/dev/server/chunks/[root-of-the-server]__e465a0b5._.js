...
"[project]/app/api/crm/settings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request) {
    try {
        ...
        if (defaultInterestRate === undefined) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Default interest rate is required'
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e465a0b5._.js.map