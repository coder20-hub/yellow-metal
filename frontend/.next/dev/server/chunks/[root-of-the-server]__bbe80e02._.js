...
"[project]/app/api/crm/admins/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getDatabase"])();
        const usersCollection = db.collection('crm_users');
        const admins = await usersCollection.find({}).project({
            password: 0
        }) // Exclude password
        .sort({
            createdAt: -1
...
async function PUT(request) {
    try {
        ...
        if (password) {
            updateData.password = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(password, 10);
        }
...
async function DELETE(request) {
    try {
        ...
        if (userToDelete.role === 'superadmin') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Cannot delete superadmin. You can only edit superadmin credentials.'
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bbe80e02._.js.map