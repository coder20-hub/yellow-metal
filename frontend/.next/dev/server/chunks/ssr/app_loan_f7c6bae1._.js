...
class LoanPlansService {
    ...
    constructor(){
        ...
        this.apiBaseUrl = `${backendBase}/api`;
    ...
    async getLoanPlans(filters = {}) {
        try {
            ...
            if (filters.loanAmount) params.append('loanAmount', filters.loanAmount.toString());
            if (filters.category) params.append('category', filters.category);
            if (filters.activeOnly !== undefined) params.append('activeOnly', filters.activeOnly.toString());
            const controller = new AbortController();
            const timeoutId = setTimeout(()=>controller.abort(), 5000); // 5 second timeout
            const response = await fetch(`${this.apiBaseUrl}/loan-plans?${params.toString()}`, {
                method: 'GET',
                headers: {
            ...
            const data = await response.json();
            if (!data.success) {
                throw new Error(data.error || 'Failed to fetch loan plans');
            }
            return {
                plans: data.plans || [],
                total: data.total || 0
            ...
            // Silently fallback to mock data if backend is unavailable
            // Only log if it's not a network/timeout error
            if (error.name !== 'AbortError' && error.name !== 'TypeError') {
                console.error('Error fetching loan plans from API, falling back to mock data:', error);
            }
...
function LoanCalculator() {
    ...
    const [interestRate, setInterestRate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(9.0);
    const [interestRateLoading, setInterestRateLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchInterestRate = async ()=>{
            try {
                ...
                const controller = new AbortController();
                const timeoutId = setTimeout(()=>controller.abort(), 5000); // 5 second timeout
                const res = await fetch(`${backendBase}/api/interest-rate`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                if (data.success && data.interestRate !== undefined) {
                    setInterestRate(data.interestRate);
                }
            } catch (err) {
                // Silently handle errors - use default 9.0
                // Only log if it's not an abort (timeout) or network error
                if (err.name !== 'AbortError' && err.name !== 'TypeError') {
                    console.error('Failed to fetch interest rate:', err);
                }
            // Keep default 9.0 - this is fine, the component will work with the default
            } finally{
...
function ApplicationForm() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchBranches = async ()=>{
            try {
                const backendBase = process.env.NEXT_PUBLIC_BACKEND_URL || 'http://localhost:4000';
                const res = await fetch(`${backendBase}/api/branches`);
                const data = await res.json();
                if (data.success && data.branches) {
                    setBranches(data.branches.sort((a, b)=>a.town.localeCompare(b.town)));
                }
            } catch (err) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (!response.ok || !data.success) {
                throw new Error(data?.errors?.join(', ') || data?.error || 'Failed to submit application');
            }
            setIsSubmitted(true);
        } catch (err) {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                    ...
                                    children: [
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        branchesLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "h-12 bg-background/50 backdrop-blur-sm border-border/50 rounded-md flex items-center justify-center",
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: "text-sm text-muted-foreground",
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$loan$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SelectTrigger"], {
                                                                    ...
                                                                    className: "h-12 bg-background/50 backdrop-blur-sm border-border/50",
                                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$loan$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SelectValue"], {
                                                                        placeholder: "Select your nearest branch or pincode"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/loan/components/ApplicationForm.tsx",
                                                                        lineNumber: 232,
                                                                        columnNumber: 25
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$loan$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SelectContent"], {
                                                                    ...
                                                                    children: branches.map((branch)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$loan$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                                            value: `${branch.town} - ${branch.pincode}`,
                                                                            children: [
                                                                                branch.town,
                                                                                " - ",
                                                                                branch.pincode
                                                                            ]
                                                                        }, branch._id || `${branch.town}-${branch.pincode}`, true, {
                                                                            fileName: "[project]/app/loan/components/ApplicationForm.tsx",
                                                                            lineNumber: 236,
                                                                            columnNumber: 27
                                                                        }, this))
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$loan$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                            ...
                                            children: isSubmitting ? 'Submitting...' : t('application.submit')
                                        }, void 0, false, {
                                            fileName: "[project]/app/loan/components/ApplicationForm.tsx",
                                            lineNumber: 276,
                                            columnNumber: 15
...
//# sourceMappingURL=app_loan_f7c6bae1._.js.map