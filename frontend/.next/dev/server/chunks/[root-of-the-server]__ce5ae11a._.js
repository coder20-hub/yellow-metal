...
"[project]/app/api/crm/loan-plans/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const plans = await plansCollection.find({}).sort({
            createdAt: -1
        }).toArray();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
async function POST(request) {
    try {
        ...
        const { name, interestRate, maxTenure, minAmount, maxAmount, processingFee, loanToValue, features, specialOffer, isPopular, category, status } = body;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ce5ae11a._.js.map